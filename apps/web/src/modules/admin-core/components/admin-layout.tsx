...
const NAV: Array<{ to: string; label: string; permissions: string[] }> = [
  ...
  { to: "/admin/house", label: "The house", permissions: ["house.manage"] },
  ...
  { to: "/admin/record", label: "The Record", permissions: ["record.manage"] },
  {
    to: "/admin/offers",
    label: "Offers",
    permissions: [
  ...
  { to: "/admin/pigeon-reach", label: "Pigeon reach", permissions: ["publishing.item.update"] },
