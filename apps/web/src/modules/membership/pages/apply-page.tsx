    ...
    <div className="max-w-standard mx-auto flex flex-col gap-8 px-6 py-16">
      <div className="flex flex-col gap-2 text-center">
        ...
        <p className="text-muted-foreground">
          Being a Friend of PAZ supports the public programme and comes with a few things back:
          see the tiers below.
        </p>
        ...
        <p className="text-muted-foreground text-sm">
          Friends of PAZ is patronage. It buys support and welcome, never a vote or a say in how
          PAZ is run.
        </p>
      </div>
      <Card>
