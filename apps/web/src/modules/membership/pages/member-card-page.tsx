  ...
  return (
    <div className="max-w-standard mx-auto flex flex-col gap-8 px-6 py-16">
      <header className="flex flex-col gap-2">
        <h1 className="font-serif text-3xl">Friend card</h1>
        {/* Standing Specifications, "Where a card exists, it should be
            legible as what it is: it carries the Friends price, and
            nothing else." Not framed as door/access control -- there
            isn't any: "Access to the house is never sold." */}
        <p className="text-muted-foreground">
          Show the verification code below to staff to receive the Friends price.
        </p>
      </header>
      ...
      <div className="flex flex-col gap-4 rounded-lg border p-6">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-muted-foreground text-xs uppercase tracking-wide">Friend no.</p>
        ...
        <div>
          <p className="text-muted-foreground text-xs uppercase tracking-wide">Friend since</p>
      ...
      {canIssue && issue.data && (
        <div className="flex flex-col items-start gap-4 rounded-lg border p-6 sm:flex-row sm:items-center">
          <QRCodeSVG
            ...
            size={128}
            className="shrink-0"
            title="Friend verification code"
          />
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground text-sm">
              Scan the code or show/read the text to staff. It&rsquo;s shown once here; issuing a
              new one at any time immediately stops the old one working.
            </p>
          </div>
        </div>
      )}
