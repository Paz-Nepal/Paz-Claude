...
const SPECS: FieldSpec[] = [
  ...
  { key: "statement_ne", label: "Statement in Nepali", type: "textarea", rows: 6 },
  {
    ...
    type: "select",
    options: [
      { value: "early", label: "An early painter (shows the one house price)" },
      { value: "signed", label: "Signed by the house (sets their own prices)" },
    ],
    hint: "An early painter's work shows the house price unless the work sets its own. The price is a setting, wall.early_price_minor.",
  },
