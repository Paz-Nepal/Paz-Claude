...
| [011](./011-transactional-email-provider.md) | Single transactional email provider behind internal utility           | **Implemented** (`send-email.ts`) — wired into reservations, membership applications/decisions, programme registration; invitations and renewal notices still deferred, see ADR text |
